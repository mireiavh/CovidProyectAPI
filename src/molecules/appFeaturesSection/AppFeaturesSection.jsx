...
function Features() {
  return (
   ...
   <div className="icons">
      ...
      <IconsFeatures image= {upImg} number={"120+"} text={"MEMBER"} />
      <IconsFeatures image= {crownImg} number={"22M"} text={"REVENUE"} />
      <IconsFeatures image= {heartImg} number={"5643"} text={"DOWNLOAD"} />
